...
//	  		-------------------------------------------------			-------------------------------------------------
            					TD(OSFT), QC_BSPC,  TD(SWAP),           QC_TAB,   QC_SPC,   QC_ENT
//	  							-----------------------------			-----------------------------
	),
	[_QWERTY] = LAYOUT_qnr_skeletyl(
//			-------------------------------------------------			-------------------------------------------------
...
//	  							-----------------------------			-----------------------------
	...
	[_NUM] = LAYOUT_qnr_skeletyl(
//	  		-------------------------------------------------			-------------------------------------------------
			XXXXXX,   DF(0),    DF(1),    DF(2),    XXXXXX,             KC_PLUS,  KC_1,     KC_2,     KC_3,     KC_LT,
//	  		-------------------------------------------------			-------------------------------------------------
...
//	  							-----------------------------			-----------------------------
	...
	[_MEDIA] = LAYOUT_qnr_skeletyl(
//	  		-------------------------------------------------			-------------------------------------------------
			QC_LOCK,  KC_F1,    KC_F2,    KC_F3,    KC_F4,              KC_VOLU,  XXXXXX,   XXXXXX,   XXXXXX,   XXXXXX,
//	  		-------------------------------------------------			-------------------------------------------------
			QC_POS,   KC_F5,    KC_F6,    KC_F7,    KC_F8,              KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MSTP,
//	  		-------------------------------------------------			-------------------------------------------------
			QC_OS,    KC_F9,    KC_F10,   KC_F11,   KC_F12,             KC_MUTE,  KC_LSFT,  QC_MOD1,  QC_MOD2,  QC_MOD3,
//	  		-------------------------------------------------			-------------------------------------------------
